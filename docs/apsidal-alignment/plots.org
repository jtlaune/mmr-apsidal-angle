...
#+BEGIN_SRC jupyter-python :session /jpy:localhost#8888:research
  ...
  for i, qit in enumerate(QS_it):
      ...
      ax[i,0].legend(bbox_to_anchor=(2., 1.25), fancybox=True, shadow=True,ncol=2)
...
[[file:./.ob-jupyter/c41a8a08eaeb91cc1341da0e80da9020ace189e9.png]]
:END:
...
#+BEGIN_SRC jupyter-python :session /jpy:localhost#8888:research
  def plotorbit(plot_iter, cuts, fig, ax):
      ...
      for cut_iter in cuts:
          ...
          #if cut_iter == cuts[0]:
          #    ax.scatter(e1*sqrt(2)*cos(pi),e1*sqrt(2)*sin(pi),
          #               c="k",label=r"$\mathbf{e_1}$",zorder=2)
          #    ax.scatter(e2/sqrt(2)*cos(pi+Dpoms),e2/sqrt(2)*sin(pi+Dpoms),
          #               c="r",label=r"$\mathbf{e_2}$",zorder=1)
          #    ax.scatter(ehat*cos(pi+hatgamma1),ehat*sin(pi+hatgamma1),
...
#+begin_example
  ...
  33941.2386344164 38183.89346371845
#+end_example
[[file:./.ob-jupyter/b7a655b929d4cef8c44689291d872f2eac611779.png]]
:END:
