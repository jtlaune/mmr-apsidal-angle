...
#+BEGIN_SRC jupyter-python :session /jpy:localhost#8888:research
  ...
  os.chdir("/home/jtlaune/Dropbox/multi-planet-architecture/docs/apsidal-alignment/")
  fig.savefig(f"{prefix}-driving-example-h-{h}-Tw0-{int(Tw0)}-q{q}.png", bbox_inches="tight")
#+END_SRC
...
[[file:./.ob-jupyter/89fa113459012b032417cded59d163585bb48be2.png]]
:END:
** example select by fname
#+BEGIN_SRC jupyter-python :session /jpy:localhost#8888:research
  os.chdir("/home/jtlaune/Dropbox/multi-planet-architecture/runs/Rhat-grid/")
  dirname = "inres-driveTe-h-0.01-mutot-1.0e-04-Tw0-10000-q2.0"
  fname = "e1d-0.100-e2d-0.000"
...
:RESULTS:
#+attr_org: :width 30
[[file:./.ob-jupyter/424a89e56f779dd22a16730a6cbd493d38bc3fa7.png]]
:END:
** perp example
#+BEGIN_SRC jupyter-python :session /jpy:localhost#8888:research
  os.chdir("/home/jtlaune/Dropbox/multi-planet-architecture/runs/Rhat-grid/")
...
:RESULTS:
: 9
: [-3.12103337  0.10232788]
: [False  True] [False False] [ True False]
[[file:./.ob-jupyter/c1d444950769b745decf1859482678d6cad58966.png]]
:END:
...
#+begin_example
  ...
  33941.2386344164 38183.89346371845
  9
  ./inres-driveTe-h-0.03-mutot-1.0e-04-Tw0-1000-q2.0/e1d-0.200-e2d-0.200.npz
  0.0 127.2796448790615
  9
  ./inres-driveTe-h-0.03-mutot-1.0e-04-Tw0-1000-q2.0/e1d-0.200-e2d-0.200.npz
  33941.2386344164 38183.89346371845
#+end_example
[[file:./.ob-jupyter/c48d01a09bc0f7b6a6158af8ccf63d72e790823a.png]]
:END:
*** in e hat ref frame
#+BEGIN_SRC jupyter-python :session /jpy:localhost#8888:research
  def plotorbit(plot_iter, cuts, fig, ax):
...
: 9
: e1d-0.000-e2d-0.200.npz
[[file:./.ob-jupyter/5695b29dc0be9ea7a7ccdaf2b3cee439762fc51b.png]]
:END:
