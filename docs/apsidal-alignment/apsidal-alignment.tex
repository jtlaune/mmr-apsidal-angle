...
used in the literature.  In Section \ref{sec:org536d437}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org36e4ff0}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org5662151}, where we design a toy model which
...
Section \ref{sec:org536d437} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org71d2f10}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:org5f72e03}.
...
found in Section \ref{sec:org536d437}.
...
The results of Section \ref{sec:org0576ca8} can be applied to the
...
Section \ref{sec:org36e4ff0}.  As a first order approximation, we
...
in Section \ref{sec:org536d437}.  However, there are
...
in the vicinity of an MMR with a planet of mass \(m_p\) (Section \ref{sec:org36e4ff0}).  Here, we briefly reviewed the textbook treatment
...
mass case in Section \ref{sec:org5662151}.  While previous studies typically
...
\label{sec:org5f72e03}
\subsection{Scaling the Hamiltonian}
\label{sec:orge2dedaf}
