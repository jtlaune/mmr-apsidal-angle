...
\ref{sec:org4f596b9}, we present the classical picture of resonant capture
...
\ref{sec:org6925ac6}, we design a toy model which relies on eccentricity
...
the primary. Details can be found in Appendix \ref{sec:orgba03fba} The quantity \(J\) is the angular momentum
...
the details of these transformations, see Appendix \ref{sec:orgba03fba}.  The parameter \(\delta\)
...
found in Section \ref{sec:org4f596b9}.
...
\label{sec:orgba03fba}
\subsection{Scaling the Hamiltonian}
\label{sec:org75b893c}
