...
\(\Gamma_i=\Lambda_i(1-\sqrt{1-e_i^2})\).  It can be shown
\cite[e.g.][]{murray_solar_2000} that \(\theta_i\) and \(\Gamma_i\) form
a conjugate pair.  Let \(\v X\) be the cartesian formulation
\begin{align}
  \v X &= (x_1, x_2, X_1, X_2)\nonumber\\
