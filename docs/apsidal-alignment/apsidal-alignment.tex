...
used in the literature.  In Section \ref{sec:orga18a94f}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:orged09b04}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org03b12d8}, where we design a toy model which
...
the primary. Details can be found in Appendix \ref{sec:org0f1d9df}. The quantity \(J\) is the angular
...
Section \ref{sec:orga18a94f} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org35ee886}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:org0f1d9df}.  The parameter \(\delta\)
...
found in Section \ref{sec:orga18a94f}.
...
\label{sec:org35ee886}
The results of Section \ref{sec:org232bf19} can be applied to the
...
Because of this, in Section \ref{sec:orged09b04}, we briefly reviewed
...
\label{sec:org0f1d9df}
\subsection{Scaling the Hamiltonian}
\label{sec:orgf5cdddb}
