...
used in the literature.  In Section \ref{sec:org10a1a1f}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org0040e95}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org41df230}, where we design a toy model which
...
Section \ref{sec:org10a1a1f} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:orge769497}. In the same section,
...
found in Section \ref{sec:org10a1a1f}.
...
outer planet.  As we saw earlier in Section \ref{sec:org0040e95}, the
...
\label{sec:orge769497}
The results of Section \ref{sec:orgf3ecbea} can be applied to the
...
Section \ref{sec:org0040e95}.  As a first order approximation, we
...
in Section \ref{sec:org10a1a1f}.  However, there are
...
in the vicinity of an MMR with a planet of mass \(m_p\) (Section \ref{sec:org0040e95}).  Here, we briefly reviewed the textbook treatment
...
mass case in Section \ref{sec:org41df230}.  While previous studies typically
...
\label{sec:org9fb9986}
\subsection{Scaling the Hamiltonian}
\label{sec:orgcae753e}
...
in Appendix \ref{sec:org9fb9986}, which is generated by the infinitessimal rotation
