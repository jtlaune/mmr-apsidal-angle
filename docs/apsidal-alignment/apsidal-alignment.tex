...
used in the literature.  In Section \ref{sec:org7b776de}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:orgdd42a40}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org56b97e9}, where we design a toy model which
...
Section \ref{sec:org7b776de} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org307d45a}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:orgc0df40e}.
...
found in Section \ref{sec:org7b776de}.
...
The results of Section \ref{sec:org617afbc} can be applied to the
...
Section \ref{sec:orgdd42a40}.  As a first order approximation, we
...
in Section \ref{sec:org7b776de}.  However, there are
...
in the vicinity of an MMR with a planet of mass \(m_p\) (Section \ref{sec:orgdd42a40}).  Here, we briefly reviewed the textbook treatment
...
mass case in Section \ref{sec:org56b97e9}.  While previous studies typically
...
\label{sec:orgc0df40e}
\subsection{Scaling the Hamiltonian}
\label{sec:orgdd6fff3}
