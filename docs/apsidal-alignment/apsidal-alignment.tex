...
used in the literature.  In Section \ref{sec:org8419c4e}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org8a90598}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org5f3b80b}, where we design a toy model which
...
Section \ref{sec:org8419c4e} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:orgdbeeb69}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:org039a4be}.
...
found in Section \ref{sec:org8419c4e}.
...
The results of Section \ref{sec:org3e7f09e} can be applied to the
...
Section \ref{sec:org8a90598}.  As a first order approximation, we
...
Because of this, in Section \ref{sec:org8a90598}, we briefly reviewed
...
\label{sec:org039a4be}
\subsection{Scaling the Hamiltonian}
\label{sec:orgbaea0e3}
