...
used in the literature.  In Section \ref{sec:org0715d2a}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:orgfd5a1da}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org538b27f}, where we design a toy model which
...
Section \ref{sec:org0715d2a} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:orgff91e29}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:org9aed0c1}.  The parameter \(\delta\)
...
found in Section \ref{sec:org0715d2a}.
...
\label{sec:orgff91e29}
The results of Section \ref{sec:org66c1106} can be applied to the
...
Because of this, in Section \ref{sec:orgfd5a1da}, we briefly reviewed
...
\label{sec:org9aed0c1}
\subsection{Scaling the Hamiltonian}
\label{sec:org552511e}
