...
used in the literature.  In Section \ref{sec:orgfb284b2}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org40f9348}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org5e082b7}, where we design a toy model which
...
the primary. Details can be found in Appendix \ref{sec:orgcebf00f}. The quantity \(J\) is the angular
...
Section \ref{sec:orgfb284b2} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org6ffca64}.

\section{Apsidal Angle}
\label{sec:org5e082b7}
...
the details of these transformations, see Appendix \ref{sec:orgcebf00f}.  The parameter \(\delta\)
...
found in Section \ref{sec:orgfb284b2}.
...
\label{sec:org6ffca64}
The results of Section \ref{sec:org15a3346} can be applied to the
...
\label{sec:orgcebf00f}
\subsection{Scaling the Hamiltonian}
\label{sec:orgff86e95}
