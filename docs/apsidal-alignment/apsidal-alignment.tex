...
used in the literature.  In Section \ref{sec:org3909d01}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:orge76996a}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org940bd9f}, where we design a toy model which
...
Section \ref{sec:org3909d01} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org3f6c067}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:org69b4fa8}.
...
found in Section \ref{sec:org3909d01}.
...
\label{sec:org3f6c067}
The results of Section \ref{sec:org251d040} can be applied to the
...
Because of this, in Section \ref{sec:orge76996a}, we briefly reviewed
...
\label{sec:org69b4fa8}
\subsection{Scaling the Hamiltonian}
\label{sec:orga72957b}
