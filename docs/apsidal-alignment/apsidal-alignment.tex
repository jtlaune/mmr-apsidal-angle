...
used in the literature.  In Section \ref{sec:org86b38a8}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org78f928e},
...
\ref{sec:org558e1a1}, where we design a toy model which relies on
...
Section \ref{sec:org86b38a8} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org51c490f}. In the same section,
...
found in Section \ref{sec:org86b38a8}.
...
outer planet.  As we saw earlier in Section \ref{sec:org78f928e}, the
...
Section \ref{sec:org78f928e}, with the goal of a heuristic
...
which we numerically investigated in Section \ref{sec:org558e1a1} (i.e. the
...
\label{sec:orge6acfd2}
We again adopt the notation used in Section \ref{sec:org78f928e} for \(q=\infty\).
...
of Section \ref{sec:org558e1a1} with \(e_{\rm eq}\) and \(e_p\) in Section \ref{sec:org78f928e}.
...
in Section \ref{sec:org86b38a8}.  However, there are
...
in the vicinity of an MMR with a planet of mass \(m_p\) (Section \ref{sec:org78f928e}).  Here, we briefly reviewed the textbook treatment
...
mass case in Section \ref{sec:org558e1a1}.  While previous studies typically
...
\label{sec:org1a85672}
\subsection{Scaling the Hamiltonian}
\label{sec:orgae28c32}
...
in Appendix \ref{sec:org1a85672}, which is generated by the infinitessimal rotation
