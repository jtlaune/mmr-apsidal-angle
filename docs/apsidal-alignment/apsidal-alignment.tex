...
\date{}
\title{Apsidal Angle of Planetary Systems in Mean Motion Resonance}
\hypersetup{
 pdfauthor={JT Laune},
 pdftitle={Apsidal Angle of Planetary Systems in Mean Motion Resonance},
 pdfkeywords={},
 pdfsubject={},
...
used in the literature.  In Section \ref{sec:org7a4fe71}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:orga54c948}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:orgc0cbfbe}, where we design a toy model which
...
Section \ref{sec:org7a4fe71} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org54fff4a}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:org2d00900}.  The parameter \(\delta\)
...
found in Section \ref{sec:org7a4fe71}.
...
\label{sec:org54fff4a}
The results of Section \ref{sec:orga4fc065} can be applied to the
...
results may naturally be interpreted aslatex:``per unit \(\Lambda_1\)".  The
...
Because of this, in Section \ref{sec:orga54c948}, we briefly reviewed
...
\label{sec:org2d00900}
\subsection{Scaling the Hamiltonian}
\label{sec:org919f5b1}
