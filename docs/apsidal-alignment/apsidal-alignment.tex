...
\ref{sec:org44e8853}, we present the classical
...
apsidal alignment.  In Section \ref{sec:org7dae013}, we explore
...
\ref{sec:orgd77affa}, where we design a toy model which relies on
...
the primary. Details can be found in Appendix \ref{sec:orge50eee4} The quantity \(J\) is the angular momentum
...
Section \ref{sec:org44e8853} for the test particle.
...
\subsubsection{{\bfseries\sffamily TODO} figure out why \(\hat\theta\) goes to 0 in test particle case}
\label{sec:org92af0b6}

\subsection{Equilibrium eccentricity and stability}
\label{sec:orge6492ff}
...
\subsubsection{{\bfseries\sffamily TODO} cite away derivation of eq ecc}
\label{sec:orgd718e9a}
\subsubsection{{\bfseries\sffamily TODO} cite away stability conditions}
\label{sec:org7c93b2b}
\subsection{Eccentric massive planet}
\label{sec:org6803344}
...
and apsidal alignment is sharp up to an error of $\sim$ 10\%.
...
\(q\to\infty\)), see Section \ref{sec:orgbbc1253}.

\section{Apsidal Angle}
\label{sec:orgd77affa}
...
the details of these transformations, see Appendix \ref{sec:orge50eee4}.  The parameter \(\delta\)
...
found in Section \ref{sec:org44e8853}.
...
\label{sec:orgbbc1253}

\subsection{Initial period ratio}
\label{sec:org57a416f}
\subsubsection{figures}
\label{sec:org6fce732}
\begin{figure*}
  \centering
...
\subsubsection{period ratios}
\label{sec:org6d9887a}
...
\subsubsection{{\bfseries\sffamily TODO} example noncapture}
\label{sec:orgd5bccca}

\subsection{Mass ratio                                                     :}
\label{sec:org171dc83}
\begin{figure*}
  \centering
...
\subsubsection{{\bfseries\sffamily TODO} example of instability}
\label{sec:orga6d7bcf}

\section{Conclusion}
\label{sec:org6005ea7}
\clearpage
\onecolumn
\appendix
\section{Reducing the Hamiltonian to a single degree of freedom}
\label{sec:orge50eee4}
\subsection{Scaling the Hamiltonian}
\label{sec:org0e4f532}
