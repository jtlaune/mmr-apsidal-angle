...
used in the literature.  In Section \ref{sec:org3095597}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org3dc3a67}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:org4e91d13}, where we design a toy model which
...
Section \ref{sec:org3095597} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:org639eab4}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:org7314d23}.
...
found in Section \ref{sec:org3095597}.
...
the eccentricities. The perpendicular systems fall just above the line
...
The results of Section \ref{sec:org654bdec} can be applied to the
...
Section \ref{sec:org3dc3a67}.  As a first order approximation, we
...
in Section \ref{sec:org3095597}.  However, there are
...
in the vicinity of an MMR with a planet of mass \(m_p\) (Section \ref{sec:org3dc3a67}).  Here, we briefly reviewed the textbook treatment
...
mass case in Section \ref{sec:org4e91d13}.  While previous studies typically
...
\label{sec:org7314d23}
\subsection{Scaling the Hamiltonian}
\label{sec:orgbd5be8d}
