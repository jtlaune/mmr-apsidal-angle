...
\(\Delta\varpi\) over the last 10$\backslash$% of the timespan.  These results are
...
\$T\textsubscript{e,i}=3.46h\textsuperscript{2T}\textsubscript{e,i}\$-- which always gives rise to apsidal
