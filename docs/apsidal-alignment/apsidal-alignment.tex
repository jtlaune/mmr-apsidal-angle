...
used in the literature.  In Section \ref{sec:orgd7243e6}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org87ea04f}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:orgd0aeb55}, where we design a toy model which
...
Section \ref{sec:orgd7243e6} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:orgbb09a59}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:orge788efc}.  The parameter \(\delta\)
...
found in Section \ref{sec:orgd7243e6}.
...
\label{sec:orgbb09a59}
The results of Section \ref{sec:org2843577} can be applied to the
...
Because of this, in Section \ref{sec:org87ea04f}, we briefly reviewed
...
\label{sec:orge788efc}
\subsection{Scaling the Hamiltonian}
\label{sec:org11a57d8}
