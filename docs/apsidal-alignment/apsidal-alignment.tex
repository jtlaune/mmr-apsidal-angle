...
used in the literature.  In Section \ref{sec:org1dfe305}, we present the classical picture of resonant capture and
...
conditions which robustly lead to apsidal alignment.  In Section \ref{sec:org9a55320}, we explore apsidal alignment for a test particle in
the vicinity of an eccentric planet's MMR. These results guide our
analysis in Section \ref{sec:orgf5b0e4e}, where we design a toy model which
...
Section \ref{sec:org1dfe305} for the test particle.
...
\(q\to\infty\)), see Section \ref{sec:orgd1a27c0}. In the same section,
...
the details of these transformations, see Appendix \ref{sec:orge4647a5}.  The parameter \(\delta\)
...
found in Section \ref{sec:org1dfe305}.
...
\label{sec:orgd1a27c0}
The results of Section \ref{sec:org0ddb8e3} can be applied to the
...
Because of this, in Section \ref{sec:org9a55320}, we briefly reviewed
...
\label{sec:orge4647a5}
\subsection{Scaling the Hamiltonian}
\label{sec:org38c9c9d}
