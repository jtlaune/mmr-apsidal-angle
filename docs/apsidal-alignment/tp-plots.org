...
:RESULTS:
#+begin_example
  /tmp/ipykernel_9935/4069442626.py:58: ComplexWarning: Casting complex values to real discards the imaginary part
    eeqs[i] = rts_R[rts_win][0]
  /tmp/ipykernel_9935/4069442626.py:58: ComplexWarning: Casting complex values to real discards the imaginary part
    eeqs[i] = rts_R[rts_win][0]
  /tmp/ipykernel_9935/4069442626.py:58: ComplexWarning: Casting complex values to real discards the imaginary part
...
#+end_example
#+attr_org: :width 471
[[file:./.ob-jupyter/4b722642f7ea11aed4b308a49c4c97f06106e784.png]]
:END:
