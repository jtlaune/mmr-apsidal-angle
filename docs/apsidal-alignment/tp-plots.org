...
:RESULTS:
#+begin_example
  /tmp/ipykernel_9935/1773820943.py:58: ComplexWarning: Casting complex values to real discards the imaginary part
    eeqs[i] = rts_R[rts_win][0]
  /tmp/ipykernel_9935/1773820943.py:58: ComplexWarning: Casting complex values to real discards the imaginary part
    eeqs[i] = rts_R[rts_win][0]
  /tmp/ipykernel_9935/1773820943.py:58: ComplexWarning: Casting complex values to real discards the imaginary part
...
#+end_example
#+attr_org: :width 469
[[file:./.ob-jupyter/3161b9e92d4efab0a4c7007edc9482385c72ccf0.png]]
:END:
