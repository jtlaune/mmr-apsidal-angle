* preamble                                                           :ignore:
#+TITLE: Apsidal Alignment and Anti-Alignment of Planets in MMR: Disk-Driven Migration and Eccentricity Driving and Damping
...
#+latex_header: \title[Apsidal Angle in MMR]{Apsidal Alignment and Anti-Alignment of Planets in MMR: Disk-Driven Migration and Eccentricity Driving and Damping}
...
**** the [[orgit:~/multi-planet-architecture/][current version (ea22ba6)]]
#+begin_src python
