...
**** the [[orgit-rev:~/multi-planet-architecture/::69b5d7691f14f5aca672e01ba96931da2ae8957c][current version (69b5d76)]]
#+begin_src python
  ax.plot(x, np.sqrt(2/1.73)*np.abs(f1/f2)*x - 0.015, ls="--", c="k")
#+end_src
...
of Section [[*Apsidal Angle]] with $e_{\rm eq}$ and $e_p$ in Section [[*Test
Particle Results]].
...
resonance. However, if disk forces drive them /away/ from the ratio
...
in Section [[Standard Picture of Resonance Capture]].  However, there are
