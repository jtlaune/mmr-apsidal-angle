...
In Section [[*Apsidal Angle]], we shifted our study of apsidal alignment
from the test particle treatment (Section [[*Test Particle Results]]) to
comparable mass planets.  We introduced the reducing rotation, which
transforms the Hamiltonian in equation eqref:hamiltonian into the
single dof form in equation eqref:hhat.  We then numerically
investigated the apsidal behavior of systems in resonance for $1/2\geq
q\leq 2$.

Because the perturbation Hamiltonian in equation
eqref:eq:Hpert1 is of the form 
