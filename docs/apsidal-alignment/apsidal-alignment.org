...
comparable mass planets (c.f. [[Reducing the Hamiltonian to a single
degree of freedom]]). For an inner (outer) test particle, $m_1=0$
...
vector with magnitude $e_i$ in the direction of perihelion.
