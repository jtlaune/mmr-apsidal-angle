...
*** DONE figure out why $\hat\theta$ goes to 0 in test particle case :noexport:
- because hat theta 1 = hat theta 2 and tp is external
** figures                                                          :ignore:
#+BEGIN_SRC latex
...
*** DONE change coordinates to physical in above eqns            :ignore:
*** DONE cite derivation away                                    :ignore:
*** DONE define thetas                                           :ignore:
...
*** DONE cite away derivation of eq ecc                            :ignore:
*** DONE cite away stability conditions                            :ignore:
*** TODO figure with eq eccentricities                             :ignore:
...
*** DONE example of escape                                       :ignore:
** Test particle limit
*** TODO this section seems dubious. check math formalism          :ignore:
***                                                                :ignore:
...
*** DONE example noncapture                                        :ignore:
...
*** DONE example of instability                                    :ignore:
* Conclusion
