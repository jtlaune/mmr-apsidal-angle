* preamble                                                           :ignore:
#+TITLE: Apsidal Angle of Planetary Systems in Mean Motion Resonance
...
represents the@@latex:``$S_2$ per unit $\Lambda_1$", and so these test particle
results may naturally be interpreted as@@latex:``per unit $\Lambda_1$".  The
