...
*** notes                                                        :noexport:
original as of <2022-04-04 Mon> edits, [[orgit-rev:/mnt/ext_adata_ssd/Dropbox/multi-planet-architecture/::1441edd576f6a193626d922f2ede041cfb87b09c][(1441edd)]]
...
We may therefore return to the test particle treatment of Section
[[*Test Particle Results]] in order to understand the apsidal alignment
process in this section for comparable mass planets.

For simplicity, we restrict ourselves to an external test particle,
which corresponds to the limit $q\to\infty$ (Figure
ref:fig:tp-grid-ext).
We may then compare it to the $q=2>1$ case, which we numerically investigated in
Section [[*Apsidal Angle]] (i.e., the first two rows Figure ref:fig:Rhat-grid).
...
comparable mass case is /roughly/ the superposition of two 
