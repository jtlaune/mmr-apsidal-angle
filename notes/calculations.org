...
#+BEGIN_SRC jupyter-python :session /jpy:localhost#8888:research
  os.chdir("/home/jtlaune/multi-planet-architecture/runs/Rhat-grid/")
  filename = "behaviors-driveTe-h-0.03-mutot-1.0e-04-Tw0-1000.txt"
  qs = [2,0.5]
  qRun = 16
  ...
  for i, qit in enumerate(qs):
      ...
      cs = ax[i,1].errorbar(e1s[aligned], e2s[aligned], xerr=e1s_std[aligned], yerr=e2s_std[aligned], fmt='o', ms=7.5, markerfacecolor='k', markeredgecolor='k')
      cs = ax[i,1].errorbar(e1s[antialigned], e2s[antialigned], xerr=e1s_std[antialigned], yerr=e2s_std[antialigned], ms=7.5, fmt='o', markerfacecolor='none', markeredgecolor='k')
      ...
      fig.savefig(os.path.join(".",
                  f"Rhat-grid-q{qs[0]}.png"),
                  bbox_inches="tight")
#+END_SRC

#+RESULTS:
:RESULTS:
: [ 3.12922633  3.10104789  0.17191099  0.34569414  3.08369475  2.90966647
:   0.21697875 -2.48770463 -3.11638133  2.86118063 -0.01763371 -2.51308898
:  -2.81970058  3.02375341]
: [-3.12435012  2.99496591  2.64762693 -3.08795248 -1.64168489 -3.06843773
:  -1.22638697 -0.91641346]
[[file:./.ob-jupyter/940654f953999e20b5f24eaac1216659a538b38b.png]]
:END:
