...
# Varying parameters #
######################
E1_0 = np.ones(Nqs)*0.2
E2_0 = np.ones(Nqs)*0.15
...
DIRNAMES = np.array([f"./e0large-h-{h:0.2f}-Tw0-{Tw0}-cut-{cutoff_frac:0.2f}-mutot-{totmass:0.1e}" for i
                        in range(Nqs)])
